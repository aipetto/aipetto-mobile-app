...
class BusinessPlaceApiClient implements BusinessPlaceOperations {
  ...
  Future<BusinessPlace> getBusinessPlaceDetail(String? businessTenant, String? placeId) async {
    ...
    final businessPlaceResponse = await this.httpClient?.get(Uri.parse(url), headers: {
    ...
    final json = jsonDecode(businessPlaceResponse?.body as String);
  ...
  Future<List<BusinessPlace>> getBusinessPlaceNearby(String? geoLocation, String? serviceId) async {
    ...
    final businessPlacesNearbyResponse = await this.httpClient?.get(Uri.parse(url), headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json'
    });
    ...
    final json = jsonDecode(businessPlacesNearbyResponse?.body as String);
