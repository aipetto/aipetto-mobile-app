...
class Pet {
  ...
  factory Pet.fromJson(Map<String, dynamic> json) => Pet(
        petOwners: List<PetOwner>.from(
            json["petOwners"].map((x) => PetOwner.fromJson(x))),
        ...
        usersAuthorized: List<PetOwner>.from(
            json["usersAuthorized"].map((x) => PetOwner.fromJson(x))),
        businessAuthorized: List<BusinessAuthorized>.from(
            json["businessAuthorized"]
                .map((x) => BusinessAuthorized.fromJson(x))),
        ...
        petFriends:
            List<Match>.from(json["petFriends"].map((x) => Match.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "isLost": isLost,
        "usersAuthorized":
            List<dynamic>.from(usersAuthorized.map((x) => x.toJson())),
        "businessAuthorized":
            List<dynamic>.from(businessAuthorized.map((x) => x.toJson())),
    ...
    String bloodType,
      ...
      Pet(
          ...
          hasBeenSterilizedSpayed:
              hasBeenSterilizedSpayed ?? this.hasBeenSterilizedSpayed,
...
class Breed {
  ...
  factory Breed.fromJson(Map<String, dynamic> json) => Breed(
        ...
        createdBy: json["createdBy"],
        updatedBy: json["updatedBy"],
        image: List<ProfileImage>.from(
            json["image"].map((x) => ProfileImage.fromJson(x))),
        createdAt: DateTime.parse(json["createdAt"]),
        updatedAt: DateTime.parse(json["updatedAt"]),
        v: json["__v"],
        breedId: json["id"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "id": breedId,
        "breeds":
            breeds == null ? null : List<dynamic>.from(breeds.map((x) => x)),
      };
}
...
class BusinessAuthorized {
  ...
  factory BusinessAuthorized.fromJson(Map<String, dynamic> json) =>
      BusinessAuthorized(
        ...
        v: json["__v"],
        addressPostCode:
            json["addressPostCode"] == null ? null : json["addressPostCode"],
        addressStreet:
            json["addressStreet"] == null ? null : json["addressStreet"],
        addressStreetNumber: json["addressStreetNumber"] == null
            ? null
            : json["addressStreetNumber"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "addressStreetNumber":
            addressStreetNumber == null ? null : addressStreetNumber,
...
class Match {
  ...
  factory Match.fromJson(Map<String, dynamic> json) => Match(
        ...
        isLost: json["isLost"],
        usersAuthorized:
            List<dynamic>.from(json["usersAuthorized"].map((x) => x)),
        businessAuthorized:
            List<dynamic>.from(json["businessAuthorized"].map((x) => x)),
        isLookingForMatch: json["isLookingForMatch"],
        diseases: List<dynamic>.from(json["diseases"].map((x) => x)),
        isGuideDog: json["isGuideDog"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "businessAuthorized":
            List<dynamic>.from(businessAuthorized.map((x) => x)),
        "isLookingForMatch": isLookingForMatch,
        "diseases": List<dynamic>.from(diseases.map((x) => x)),
        "isGuideDog": isGuideDog,
...
class Photo {
  ...
  factory Photo.fromJson(Map<String, dynamic> json) => Photo(
        ...
        photo: List<ProfileImage>.from(
            json["photo"].map((x) => ProfileImage.fromJson(x))),
        petId: json["petId"],
