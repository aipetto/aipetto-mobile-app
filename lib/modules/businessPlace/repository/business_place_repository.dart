...
class BusinessPlaceRespository {
  ...
  Future<List<BusinessPlace>> fetchBusinessPlacesNearby(String geolocation, String serviceId) async {
    return await businessPlaceApiClient.getBusinessPlaceNearby(geolocation, serviceId);
  }
